    ...
    public class Scanner
    {
        ...
        void CheckLiteral()
        {
            switch (t.val)
            {
                ...
                case "vertex": t.kind = 7; break;
                case "edge": t.kind = 8; break;
                case "list": t.kind = 17; break;
                case "set": t.kind = 20; break;
                case "queue": t.kind = 21; break;
                case "stack": t.kind = 22; break;
                case "number": t.kind = 23; break;
                case "bool": t.kind = 24; break;
                case "text": t.kind = 25; break;
                default: break;
            }
        }
